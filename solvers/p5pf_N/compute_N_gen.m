...
% Input : p1, p2 are the image point measurements in the two cameras, G1 and
% G2, and K_gen1, R_gen1, t_gen1 are the calib matrices for G1. R_gen1,
% t_gen1 are the rigid body transformations which align the global
% coordinate system to that of G1 and likewise the rest of the quantities
% mean for G2.
% The output is the plane vector in the global coordinate system.
